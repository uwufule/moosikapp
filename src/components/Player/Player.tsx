...
const Player = () => {
  ...
  const isVolumeSliderHidden = useMedia('(max-width: 640px)');
  const isSoundBadgeHidden = useMedia('(max-width: 960px)');
  ...
  return (
    <Wrapper>
      <PlayerContainer>
        ...
        {!isSoundBadgeHidden && <SoundBadge author="Song Author" title="Song Title" />}
      </PlayerContainer>
    </Wrapper>
  );
};
